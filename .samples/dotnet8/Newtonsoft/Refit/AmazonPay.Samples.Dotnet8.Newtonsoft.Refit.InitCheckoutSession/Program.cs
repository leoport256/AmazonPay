...
using AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession;
using AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession.Confirm;
using AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession.Initialize;
using AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession.Review;
using Microsoft.AspNetCore.Mvc;
using Request = AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession.Initialize.Request;
...
{
	var result = await service.Review(new AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession.Review.Request(
...
{
	var resut = await service.Confirm(new AmazonPay.Samples.Dotnet8.Newtonsoft.Refit.InitCheckoutSession.Confirm.Request(checkoutSessionId));
