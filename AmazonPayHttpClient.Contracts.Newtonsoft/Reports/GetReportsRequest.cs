...
{
	public GetReportsRequest(List<ReportTypes>? reportTypes = null, List<ProcessingStatus>? processingStatuses = null,
		DateTime? createdSince = null, DateTime? createdUntil = null, int pageSize = 10, string? nextToken = null)
	{
	...
	/// </summary>
	[JsonProperty("processingStatuses")]
